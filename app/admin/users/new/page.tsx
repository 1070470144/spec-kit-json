          ...
          await createUser(base, cookieHeader, { email, password, nickname, avatarUrl, roleKeys: roles })
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <label className="block">
                <div className="muted mb-1">邮箱</div>
                <input className="input" name="email" placeholder="邮箱" />
              </label>
              <label className="block">
                <div className="muted mb-1">初始密码</div>
                <input className="input" type="password" name="password" placeholder="初始密码" />
              </label>
              <label className="block">
                <div className="muted mb-1">昵称（可选）</div>
                <input className="input" name="nickname" placeholder="昵称（可选）" />
              </label>
              <label className="block">
                <div className="muted mb-1">头像URL（可选）</div>
